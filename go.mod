...
require (
	github.com/coinexchain/cet-sdk v0.2.5-alpha.0.20200325084515-467f3c05d9e6
...
replace github.com/tendermint/tendermint => github.com/coinexchain/tendermint v0.32.903
