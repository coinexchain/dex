...
const (
	...
	TokenWhitelistAddFee    = 2E9  // 20 * 10 ^ 8
	TokenWhitelistRemoveFee = 2E9  // 20 * 10 ^ 8
	BurnFee                 = 1E9  // 10 * 10 ^ 8
	MintFee                 = 1E9  // 10 * 10 ^ 8
)
...
var (
	...
	KeyTokenWhitelistAddFee    = []byte("TokenWhitelistAddFee")
	KeyTokenWhitelistRemoveFee = []byte("TokenWhitelistRemoveFee")
...
type Params struct {
	...
	TokenWhitelistAddFee    sdk.Coins `json:"token_whitelist_add_fee"`
	TokenWhitelistRemoveFee sdk.Coins `json:"token_whitelist_remove_fee"`
...
func (p *Params) ParamSetPairs() params.ParamSetPairs {
	return params.ParamSetPairs{
		...
		{Key: KeyTokenWhitelistAddFee, Value: &p.TokenWhitelistAddFee},
		{Key: KeyTokenWhitelistRemoveFee, Value: &p.TokenWhitelistRemoveFee},
