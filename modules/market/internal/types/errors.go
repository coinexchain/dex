...
const (
	...
	CodeInvalidAddress         sdk.CodeType = 605
	CodeNotExistKeyInStore     sdk.CodeType = 606
	CodeInsufficientCoin       sdk.CodeType = 607
	CodeInvalidTradeSide       sdk.CodeType = 608
	CodeInvalidOrderType       sdk.CodeType = 609
	CodeInvalidSymbol          sdk.CodeType = 610
	CodeTokenForbidByIssuer    sdk.CodeType = 611
	CodeInvalidOrderID         sdk.CodeType = 612
	CodeMarshalFailed          sdk.CodeType = 613
	CodeOrderNotFound          sdk.CodeType = 614
	CodeNotMatchSender         sdk.CodeType = 615
	CodeInvalidCancelTime      sdk.CodeType = 616
	CodeAddressForbidByIssuer  sdk.CodeType = 617
	CodeInvalidOrderCommission sdk.CodeType = 618
	CodeNotListedAgainstCet    sdk.CodeType = 619
	CodeRepeatTradingPair      sdk.CodeType = 620
	CodeDelistNotAllowed       sdk.CodeType = 621
	CodeInvalidOrderAmount     sdk.CodeType = 622
	CodeInvalidExistBlocks     sdk.CodeType = 623
	CodeInvalidTimeInForce     sdk.CodeType = 624
	CodeOrderAlreadyExist      sdk.CodeType = 625
	CodeDelistRequestExist     sdk.CodeType = 626
	CodeInvalidMarket          sdk.CodeType = 627
)
